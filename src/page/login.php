			...
			<div class="row justify-content-center">
				<div class="col-md-6 col-lg-4">
		      	...
		      	<form action="" class="signin-form" onclick="event.preventDefault(); event.stopImmediatePropagation();">
					...
					<div class="form-group">
						<input id="password" type="password" class="form-control" placeholder="Password" toggle="true" required>
						<span toggle="#password-field" class="fa fa-fw fa-eye field-icon toggle-password"></span>
					</div>
					<div class="form-group">
						<button type="submit" class="bg-orange form-control btn submit px-3" onclick="log(this, 'login')">Sign In</button>
					</div>
