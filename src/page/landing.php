...
<body class="bg-black muli">
    <nav class="w-100pc flex flex-column md-flex-row md-px-10 py-5 bg-black">
        ...
        <div id="nav-items" class="hidden flex sm-w-100pc flex-column md-flex md-flex-row md-justify-end items-center">
            ...
            <a href="#investment" class="fs-s1 mx-3 py-3 indigo no-underline hover-underline">Investments</a>
            <a href="login" class="button bg-white black fw-600 no-underline mx-5 mt-2 mb-2">Login</a>
            <a href="register" class="button bg-white black fw-600 no-underline mx-5 mt-2 mb-2">Register</a>
        </div>
    </nav>
    ...
    <section id="home" class="min-h-100vh flex justify-start items-center">
        <div class="mx-5 md-mx-l5">
             <div class="inline-block bg-indigo-30 indigo-lightest p-2 fs-s2 mb-5 w-100 justify-center">
                <img src="assets/images/bg/background.webp" alt="" style="width: 300px; height: 300px; margin: auto;" class="mx-auto">
            </div>
            <div>
                <h1 class="white fs-l3 lh-2 md-fs-xl1 md-lh-1 fw-900 ">No #1 Investment <br />Platform Since 2020</h1>

                <div class="br-8 mt-10 inline-flex">
                    <button
                        class="button-lg bg-indigo-light-20 indigo-lightest focus-white fw-300 fs-s3 mr-0 br-l-0">Login</button>
                        &ensp;
                    <button
                        class="button-lg bg-indigo-lightest-20 indigo-lightest focus-white fw-300 fs-s3 mr-0 br-l-0">Join Us</button>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="flex flex-column md-flex-row mx-auto">
            <div class="w-100pc md-w-40pc">
                <div class="br-8 p-5 m-5">
                    ...
                    <h4 class="yellow fw-600 fs-m3 mb-5">Expert Guidance</h4>
                    <div class="indigo-lightest fw-600 fs-m1 lh-3 opacity-50">Our team of experienced financial experts and advisors are here to offer guidance and insights. We provide up-to-date market analysis, investment tips, and personalized advice to help you make informed decisions.</div>
                    <a href="login"
                        class="mt-5 button bg-indigo-lightest-10 fs-s3 white no-underline hover-opacity-100 hover-scale-up-1 ease-300">Get Started</a>
                </div>
            </div>
            <div class="w-100pc md-w-40pc">
                <div class="br-8 p-5 m-5">
                    ...
                    <h4 class="yellow fw-600 fs-m3 mb-5">Diverse Investments</h4>
                    <div class="indigo-lightest fw-600 fs-m1 opacity-50">We cover a wide range of investment options, including stocks, bonds, mutual funds, real estate, cryptocurrencies, and more. Our website provides in-depth information on each investment class to help you diversify your portfolio effectively.</div>
                    <a href="login"
            ...
            <div class="w-100pc md-w-40pc">
                <div class="br-8 p-5 m-5">
                    ...
                    <h4 class="yellow fw-600 fs-m3 mb-5">Security and Privacy</h4>
                    <div class="indigo-lightest fw-600 fs-m1 opacity-50">We take your security and privacy seriously. InvestWise employs the latest encryption and data protection measures to ensure your personal and financial information is safe.</div>
                    <a href="login"
                        class="mt-5 button bg-indigo-lightest-10 fs-s3 white no-underline hover-opacity-100 hover-scale-up-1 ease-300">Read</a>
                </div>
            </div>
    ...
    <section class="relative bg-indigo-lightest-10" id="about">
        <div id="slider-1">
            <div class="p-10 md-p-l10 flex justify-center items-center flex-column text-center">
                <h2 class="yellow fs-l3 fw-900">Largebounds Coperate Investment</h2>
                <p class="indigo-lightest fw-600 fs-m1 opacity-30 my-5">Largebounds is committed to helping you build a prosperous financial future. Your financial success is our priority, and our website is designed to be your one-stop hub for all things investment-related. Join us on your journey to financial freedom and make InvestWise your trusted companion in the world of investing.</p>
                <a href="register" class="button-md bg-indigo white fs-s3 br-4 black fw-600 no-underline m-5">Join Us</a>
            </div>
            <div class="p-10 md-p-l10 flex justify-center items-center flex-column text-center">
                <h2 class="yellow fs-l3 fw-900">Plan Your Investment</h2>
                <p class="indigo-lightest fw-600 fs-m1 opacity-30 my-5">Utilize our investment calculators and risk assessment tools to create a tailored investment plan that suits your financial goals and risk tolerance.
                    <br>
                From understanding the basics of stocks and bonds to advanced strategies like options trading, our resources cater to all levels of expertise.
                </p>
                <a href="register" class="button-md bg-indigo white fs-s3 br-4 black fw-600 no-underline m-5">Join Us</a>
            </div>
            <div class="p-10 md-p-l10 flex justify-center items-center flex-column text-center">
                <h2 class="yellow fs-l3 fw-900">News and Updates</h2>
                <p class="indigo-lightest fw-600 fs-m1 opacity-30 my-5">Stay updated with the latest market news and trends. Our website offers daily updates, market analysis, and investment news to help you stay ahead of the curve. 
                    <br>
                Our experts regularly update these reports, ensuring you're always equipped with the latest information.</p>
                <a href="register" class="button-md bg-indigo white fs-s3 br-4 black fw-600 no-underline m-5">Join Us</a>
            </div>
        </div>
    ...
    <section class="p-10 md-py-10">
        <div class="w-100pc md-w-70pc mx-auto py-10">
            <h2 class="yellow fs-l2 md-fs-xl1 fw-900 lh-2">
                Get to know how your money is been, <span class="border-b bc-indigo bw-4"> invested</span> and how your profit is been refunded. </h2>
        </div>
    </section>

    <!-- product options -->
    <section class="py-l10" id="investment">
        <div class="flex flex-column md-flex-row md-w-80pc mx-auto">
            <div class="w-100pc md-w-50pc">
                <div class="br-8 p-5 m-5 bg-indigo-lightest-10 pointer hover-scale-up-1 ease-300">
                    <div class="inline-block bg-green indigo-lightest br-3 px-4 py-1 mb-10 fs-s4 uppercase">
                        Agriculture</div>
                    <div>
                        <img src="assets/images/investments/agric.jpeg" style="height: 350px; object-fit: cover;" class="br-3" alt="">
                    </div>
                    
                    <div class="indigo-lightest fw-600 fs-m1">Investing in agriculture <span class="opacity-30">  isn't just about potential financial gains; it's a way to contribute to global food security and sustainable practices. As the world faces challenges like climate change, it's increasingly important to invest in an industry that's at the intersection of economic growth and environmental stewardship. By considering agriculture in your investment portfolio, you can cultivate wealth and play a role in building a more sustainable and prosperous future.</span> </div>
                    <a href="#" class="mt-10 button bg-black fs-s3 white no-underline">Read</a>
                </div>
            </div>
            <div class="w-100pc md-w-50pc">
                <div class="br-8 p-5 m-5 bg-indigo-lightest-10  pointer hover-scale-up-1 ease-300">
                    <div class="inline-block bg-blue indigo-lightest br-3 px-4 py-1 mb-10 fs-s4 uppercase">
                        Real Estate</div>
                    <div>
                        <img src="assets/images/investments/estate.jpeg" style="height: 350px; object-fit: cover;" class="br-3" alt="">
                    </div>
                    <div class="indigo-lightest fw-600 fs-m1">Real estate investment<span class="opacity-30">  offers a path to financial stability, wealth creation, and diversification. Whether you're seeking regular income or long-term capital appreciation, the real estate market provides a variety of investment options to suit your objectives and risk tolerance. When approached with careful research, due diligence, and a long-term perspective, real estate investment can be a cornerstone of your financial success and security.</span> </div>
                    <a href="#" class="mt-10 button bg-black fs-s3 white no-underline">Read</a>
            ...
            <div class="w-100pc md-w-50pc">
                <div class="br-8 p-5 m-5 bg-indigo-lightest-10  pointer hover-scale-up-1 ease-300">
                    <div class="inline-block bg-black indigo-lightest br-3 px-4 py-1 mb-10 fs-s4 uppercase">
                        Real Estate</div>
                    <div>
                        <img src="assets/images/investments/bonds.webp" style="height: 350px; object-fit: cover;" class="br-3" alt="">
                    </div>
                    <div class="indigo-lightest fw-600 fs-m1">Bonds <span class="opacity-30"> are a vital component of a well-rounded investment strategy, offering safety, income, and stability. They can be a reliable source of regular returns and are particularly attractive to risk-averse investors. The selection of the right bonds depends on individual investment objectives, risk tolerance, and time horizon.
    ...
    <section id="pricing">
        <div class="p-10 flex flex-wrap">
            <div class="w-100pc md-w-50pc">
                <div class="p-5">
                    <h4 class="white fw-800 fs-l3 mb-5">Our Pricing</h4>
                    <div class="indigo-lightest fw-600 fs-m1 opacity-50">We have a variety of pricing option to accomodate almost and everyone.</div>
            ...
            <div class="w-100pc md-w-25pc">
                <div class="m-3 p-5 br-8 bg-indigo-lightest-10 overflow-hidden">
                    <div class="p-3">
                        <h3 class="indigo">Starter</h3>
                        <div class="white flex items-center">$<span class="fs-l1 lh-1">100</span> - 3999</div>
                    </div>
                    <div class="p-3 indigo-lightest fw-400 fs-s1 lh-5">
                        <div>
                            <i class="h-3 indigo" stroke-width="4" data-feather="check"></i>
                            <span class="opacity-50">3% ROI</span>
                        </div>
                        <div>
                            <i class="h-3 indigo" stroke-width="4" data-feather="check"></i>
                            <span class="opacity-50">Daily for 5 Days</span></div>
                        <div>
                            <i class="h-3 indigo" stroke-width="4" data-feather="check"></i>
                            <span class="opacity-50">Live Progress</span></div>
                        <div>
                            <i class="h-3 indigo" stroke-width="4" data-feather="check"></i>
            ...
            <div class="w-100pc md-w-25pc">
                <div class="m-3 p-5 br-8 bg-white overflow-hidden">
                    <div class="p-3">
                        <h3 class="indigo">Bronze</h3>
                        <div class="black flex items-center">$<span class="fs-l1 lh-1">4000</span> - 9,999</div>
                    </div>
                    <div class="p-3 black fw-400 fs-s1 lh-5">
                        <div>
                            <i class="h-3 indigo" stroke-width="4" data-feather="check"></i>
                            <span class="opacity-50"> 5% ROI</span></div>
                        <div>
                            <i class="h-3 indigo" stroke-width="4" data-feather="check"></i>
                            <span class="opacity-50">Daily for 5 Days</span></div>
                        <div>
            ...
            <div class="m-3 p-5 br-8 bg-indigo-lightest-10 overflow-hidden">
                <div class="p-3">
                    <h3 class="indigo">Gold</h3>
                    <div class="white flex items-center">$<span class="fs-l1 lh-1">10,000</span> - 14,999</div>
                </div>
                <div class="p-3 indigo-lightest fw-400 fs-s1 lh-5">
                    <div>
                        <i class="h-3 indigo" stroke-width="4" data-feather="check"></i>
                        <span class="opacity-50">7% ROI</span>
                    </div>
                    <div>
                        <i class="h-3 indigo" stroke-width="4" data-feather="check"></i>
                        <span class="opacity-50">Daily for 5 Days</span></div>
            ...
            <div class="w-100pc md-w-25pc">
                <div class="m-3 p-5 br-8 bg-white overflow-hidden">
                    <div class="p-3">
                        <h3 class="indigo">Mining</h3>
                        <div class="black flex items-center">$<span class="fs-l1 lh-1">15,000</span> - 25,000,000</div>
                    </div>
                    <div class="p-3 black fw-400 fs-s1 lh-5">
                        <div>
                            <i class="h-3 indigo" stroke-width="4" data-feather="check"></i>
                            <span class="opacity-50"> 25% ROI</span></div>
                        <div>
                            <i class="h-3 indigo" stroke-width="4" data-feather="check"></i>
                            <span class="opacity-50">3 Days interval for 30 Days</span></div>
                        <div>
                            <i class="h-3 indigo" stroke-width="4" data-feather="check"></i>
                            <span class="opacity-50">Live Progress</span></div>
                        <div>
    ...
    <!-- testimonials -->
    <section class="p-15 md-p-l5">
        <div id="slider-2">
            <div class="px-3">
                <div class="p-8 br-8 bg-indigo-lightest-10 relative">
                    <span class="fs-l5 lh-1 white opacity-10 absolute top-0 z--1">&#10077;</span>
                    <p class="fw-600 fs-m1 indigo-lightest opacity-80 italic ls-wider">Choosing Largebounds was one of the best decisions we made. Their experts guided us every step of the way, making a complex project feel manageable. They are a team of true professionals who know their craft. We are grateful for their dedication and expertise. </p>
                    <div class="flex items-center my-5">
                        <div class="block br-round border bc-black bw-4 w-l3 h-l3"><img class="br-round"
                                src="assets/images/testimonial/testim1.jpeg" alt=""></div>
                        <div class="ml-4 fs-s1">
                            <div class="indigo-lightest">Mahnaz Farzin</div>
                            <div class="indigo-lightest opacity-20"> CTO at TechSolutions Inc.</div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="px-3">
                <div class="p-8 br-8 bg-indigo-lightest-10 relative">
                    <span class="fs-l5 lh-1 white opacity-10 absolute top-0 z--1">&#10077;</span>
                    <p class="fw-600 fs-m1 indigo-lightest opacity-80 italic ls-wider">The proof of Largenbound's excellence is in the numbers. Since we started working with them, our revenue has seen a significant boost, and our online presence has never been stronger. Their team is not just about promises but real, tangible results.</p>
                    <div class="flex items-center my-5">
                        <div class="block br-round border bc-black bw-4 w-l3 h-l3"><img class="br-round"
                                src="assets/images/testimonial/testim3.jpeg" alt=""></div>
                        <div class="ml-4 fs-s1">
                            <div class="indigo-lightest">Louis Diego</div>
                            <div class="indigo-lightest opacity-20">Small Business Owner</div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="px-3">
                <div class="p-8 br-8 bg-indigo-lightest-10 relative">
                    <span class="fs-l5 lh-1 white opacity-10 absolute top-0 z--1">&#10077;</span>
                    <p class="fw-600 fs-m1 indigo-lightest opacity-80 italic ls-wider">Largebounds consistently goes above and beyond. We've been with them for years, and they have consistently delivered outstanding results. Their dedication to customer satisfaction is truly commendable. We couldn't be happier with their services.</p>
                    <div class="flex items-center my-5">
                        <div class="block br-round border bc-black bw-4 w-l3 h-l3"><img class="br-round"
                                src="assets/images/testimonial/testim2.jpeg" alt=""></div>
                        <div class="ml-4 fs-s1">
                            <div class="indigo-lightest">Sarah Brown</div>
                            <div class="indigo-lightest opacity-20">E-commerce Entrepreneur</div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="px-3">
                <div class="p-8 br-8 bg-indigo-lightest-10 relative">
                    <span class="fs-l5 lh-1 white opacity-10 absolute top-0 z--1">&#10077;</span>
                    <p class="fw-600 fs-m1 indigo-lightest opacity-80 italic ls-wider">Working with Largebounds has been a game-changer for our business. Their expertise and commitment to our project were evident from day one. They delivered on time and on budget, and the results have been nothing short of remarkable. Thank you for your exceptional service!</p>
                    <div class="flex items-center my-5">
                        <div class="block br-round border bc-black bw-4 w-l3 h-l3"><img class="br-round"
                                src="assets/images/testimonial/testim4.jpeg" alt=""></div>
                        <div class="ml-4 fs-s1">
                            <div class="indigo-lightest">Mark Smith</div>
                            <div class="indigo-lightest opacity-20">Marketing Director</div>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <section class="p-10 md-p-l5">
        <div class="br-8 bg-indigo-lightest-10 p-5 md-p-l5 flex flex-wrap md-justify-between md-items-center">
            <div class="w-100pc md-w-33pc">
                <h2 class="white fs-m4 fw-800">Get Updates from us</h2>
                <p class="fw-600 indigo-lightest opacity-40">Get to know about our latest updates on our pricing plans.</p>
            </div>
            <div class="w-100pc md-w-50pc">
                <div class="flex my-5">
                    <input type="text"
                        class="input-md flex-grow-1 bw-0 fw-200 bg-indigo-lightest-10 white ph-indigo-lightest focus-white opacity-80 fs-s3 py-5 br-r-0"
                        placeholder="Email Address">
                    <button class="button-sm bc-indigo px-2 bg-indigo indigo-lightest fw-300 fs-s3 br-l-0">Get Started</button>
                </div>
            </div>
        </div>
    </section>
    ...
    <!-- footer -->
    <footer class="w-95pc p-5 mx-auto md-p-l5 bg-indigo-lightest-10">
        <div class="flex flex-wrap">
            <div class="md-w-25pc mb-10">
                <img src="assets/images/logo.png" class="w-l5" alt="">
                <div class="white opacity-70 fs-s2 mt-4 md-pr-10">
                    <p>InvestWise is committed to helping you build a prosperous financial future. Your financial success is our priority, and our website is designed to be your one-stop hub for all things investment-related. </p>
                    <br>
                    <p>Join us on your journey to financial freedom and make InvestWise your trusted companion in the world of investing. Start making informed investment decisions today!</p>
                </div>
            </div>
            <div class="w-100pc md-w-50pc">
                <div class="flex justify-left">
                    <div class="w-33pc md-px-10 mb-10">
                        ...
                        <ul class="list-none mt-5 fs-s2">
                            ...
                            <li class="my-3"><a href="#" class="white opacity-70 no-underline hover-underline">Investments</a>
                            </li>
                            <li class="my-3"><a href="#"
                                    class="white opacity-70 no-underline hover-underline">Pricing Plan</a></li>
                            <li class="my-3"><a href="#" class="white opacity-70 no-underline hover-underline">Contact</a>
                            </li>
                        </ul>
                    </div>
                </div>
